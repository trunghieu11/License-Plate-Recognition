...
class VehicleDetection():
    def __init__(self, vehicle_weights='data/vehicle-detector/yolov2.weights',
                 vehicle_netcfg='data/vehicle-detector/yolov2.cfg',
                 vehicle_dataset='data/vehicle-detector/coco.data',
                 vehicle_threshold=0.5):

        self.vehicle_net = dn.load_net(vehicle_netcfg.encode(
    ...
    def predict(self, img, bname):
        ...
        R, _ = detect_image(self.vehicle_net, self.vehicle_meta,
                            img, thresh=self.vehicle_threshold)
